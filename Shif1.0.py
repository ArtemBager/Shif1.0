...
inf2=Label(tab4, text='2) Указать все необходимы данные для этого метода').place(relx=0, rely=0.08)
inf3=Label(tab4, text='3) ').place(relx=0, rely=0.16)
inf4=Label(tab4, text='В разработке').place(relx=0, rely=0.24)
inf5=Label(tab4, text='В разработке').place(relx=0, rely=0.32)
inf6=Label(tab4, text='В разработке').place(relx=0, rely=0.4)
inf7=Label(tab4, text='В разработке').place(relx=0, rely=0.48)
inf8=Label(tab4, text='В разработке').place(relx=0, rely=0.56)

#О методах шифрования
infS1=Label(tab5, text='В разработке').place(relx=0, rely=0)
infS2=Label(tab5, text='В разработке').place(relx=0, rely=0.08)
infS3=Label(tab5, text='В разработке').place(relx=0, rely=0.16)
infS4=Label(tab5, text='В разработке').place(relx=0, rely=0.24)
infS5=Label(tab5, text='В разработке').place(relx=0, rely=0.32)
infS6=Label(tab5, text='В разработке').place(relx=0, rely=0.4)
infS7=Label(tab5, text='В разработке').place(relx=0, rely=0.48)
infS8=Label(tab5, text='В разработке').place(relx=0, rely=0.56)
